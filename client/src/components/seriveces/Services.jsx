   ...
   return (
     <>
             ...
             <div className="row">
               ...
               >
                 <div className="news-item">
                   ...
                   <div className="news-contents mb-4">
                     <h3>
                       <a href="#">Managing the risks of deploying software</a>
                     </h3>
                     <p>
                     ...
                     <span className="post-meta-2">
                       Digital Service, 4 min read
                     </span>
                   </div>
                   <p className="mb-0">
               ...
               >
                 <div className="news-item">
                   ...
                   <div className="news-contents mb-4">
                     <h3>
                       <a href="#">Using an integration broker with SaaS</a>
                     </h3>
                     <p>
                       Separated they live in Bookmarksgrove right at the coast
                       of the Semantics, a large language ocean. A small river
               ...
               >
                 <div className="news-item">
                   ...
                   <div className="news-contents mb-4">
                     <h3>
                       <a href="#">
                         Would a cloud outage cripple your business?
                       </a>
                     </h3>
                     <p>
                       Separated they live in Bookmarksgrove right at the coast
       ...
       <section
         ...
         id="app"
         style={{ backgroundColor: "#03a4ed", height: "700px" }}
       >
         <div className="container" style={{ paddingTop: "7%" }}>
           <div className="row">
             <div className="col-lg-6 download-left">
               <img
                 className="img-fluid"
                 src="./src/public/images/Services4.png"
                 alt=""
               />
             </div>
