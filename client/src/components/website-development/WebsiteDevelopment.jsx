              ...
              <div className="row">
                <div className="col-lg-6 align-self-center">
                  ...
                  >
                    ...
                    <p>
                      ...
                      with our AI models. ThisJust integrate them in your
                      website.
                    </p>
                ...
                <div className="col-lg-6">
                  ...
                  >
                    <img
                      className="image1"
                      src="/src/public/images/how-ai-can-change-customer-service-fo-the-better.png"
                      alt="team meeting"
                    />
                  </div>
                </div>
          ...
          <div className="row justify-content-between">
            <div className="col-lg-5 order-lg-2 js-custom-dots">
              <a
                ...
                data-aos-delay={0}
              >
                <div className="service-icon color-1 mb-4"></div> {/* /.icon */}
              ...
              >
                <div className="service-icon color-2 mb-4">
                  <img
                    ...
                    src="./src/public/images/20-1-1024x597.jpg"
                    alt=""
                    width="1em"
                    height="1em"
                    viewBox="0 0 16 16"
